...
![xeny6oa6.png](media/xeny6oa6.png)

The ideal scenario demonstrates how **Copilot → Work IQ → Foundry IQ → Fabric IQ** work together:

![Scenerio-Demonstration-matched-style.png](media/Scenerio-Demonstration-matched-style.png)
...
1. Select the **Workspaces** option and choose the **workspace@lab.LabInstance.Id** workspace.
    ...
    ![Workspace11.png](media/Workspace11.png)

1. Select **+ New item** and select `Lakehouse` from the available options.



	![Lakehouse11.png](media/Lakehouse11.png)      
...
1. Select on the Filter option in the OneLake Catalog, In the filter pane, select Lakehouse, Choose the Retail_Lakehouse_-1 Lakehouse that was created previously and select Connect.

    ![SelectLakehouse.png](media/52qosf37.png) 
...
1. In the pop-up window, click **Publish**.
   ...
   ![Publish Dagent.png](media/PublishDagent.png)
...
1. Search for +++**Fabric IQ (OneLake Catalog)**+++ in the search bar, select it, then click on **Add tools**.
...
1. Look at the **URL** at the top of the **browser** and **copy** the following information into text **boxes** below:
	...
	![dataagent.png](media/dataagent.png)
...
1. Select **Fabric Data Agent**, and then select **Add tool**.
  ...
  ![qc93aq49.png](media/qc93aq49.png)
...
1. Select **Connect**.
  ...
  ![5izgg71g.png](media/5izgg71g.png)
